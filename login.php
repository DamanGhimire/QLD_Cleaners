...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username_err) && empty($password_err)) {
        $sql = "SELECT id,username,password,user_type from shiny_users where username =? ";
        if ($stmt = mysqli_prepare($link, $sql)) {
            ...
            if (mysqli_stmt_execute($stmt)) {
                ...
                if (mysqli_stmt_num_rows($stmt) == 1) {
                    ...
                    mysqli_stmt_bind_result($stmt, $id, $username, $hash, $user_type);
                    if (mysqli_stmt_fetch($stmt)) {
                        if (password_verify($password, $hash)) {
							...
							$_SESSION['msge']	=	"Invalid Username or password!!";
	...
	<div class="container">
		<div class="jumbotron">
			<div class="row">
				...
				<?php if(isset($_SESSION['msge'])){?>
					<div class="alert alert-danger alert-dismissible alert-pass-change">
						<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
						<strong><?php echo $_SESSION['msge']; unset($_SESSION['msge']);?></strong> 
					</div>
				<?php } ?>
					<div id="loginbox" style="margin-top:10px;">                    
	                    ...
	                    <div style="padding-top:30px" class="panel-body" >
                            ...
                            <!-- Button -->
        	                    <div class="col-sm-12 controls" id="login">
