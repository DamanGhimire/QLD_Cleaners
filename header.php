                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto" >
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="background-color: #00bfff">
                                    <a class="dropdown-item" href="endofleasecleaning.php" style="color: white" >End of Lease Cleaning</a>
                                    <a class="dropdown-item" href="carpetcleaning.php" style="color: white">Carpet Cleaning</a>
                                    <a class="dropdown-item" href="windowcleaning.php" style="color: white">Window Cleaning</a>
                                </div>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="request_quote.php" style="color:white" >Request Quote</a>
                            </li>
                            <li class="nav-item">
